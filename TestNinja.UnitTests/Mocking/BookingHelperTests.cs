...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        public void Setup()
        {
            ...
            _repository.Setup(s => s.FindActiveBookings(1)).Returns(new List<Booking>
            {
                _existingBooking
            }.AsQueryable());
        }
        ...
        [Test]
        public void BookingOccursBeforeExistingBookingAndFinishesInMiddleOfExistingBooking_ReturnBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingOccursBeforeExistingBookingAndFinishesAfterExistingBooking_ReturnBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingOccursInTheMiddleOfAnExistingBookingAndFinishesAfter_ReturnBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingOccursAfterExistingBooking_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
